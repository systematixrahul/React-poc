...
CategoryLinks[0].linkslabel.map(function (accessories) {
  return accessories.car1.map(function (cat) {
    return console.log(car1.name);
  });
});
...
//# sourceMappingURL=men-product.js.92c598a53f77de312ed8.hot-update.js.map